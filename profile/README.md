# Extensible Workflow System: Applications
...
[Ewoks Apps](https://ewoks.esrf.fr/en/latest/tasks/index.html) are python libraries that implement _Ewoks tasks_
which can be used as nodes on _Ewoks workflows_.
